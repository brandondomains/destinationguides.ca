...
layout: default
title: Countries
description: Country guides: entry basics, seasons, costs, and planning logic.
permalink: /countries/
breadcrumbs:
  - label: Countries
---
...
<section class="hero">
  ...
  <div class="wrap heroInner">
    ...
    <p class="dek">Country guides: entry basics, seasons, costs, and planning logic.</p>
    <div class="searchPanel">
      <div class="searchBar"><span aria-hidden="true">⌕</span><input data-search-input placeholder="Search Countries…" autocomplete="off"></div>
  ...
  <article class="article">
    <section class="section" id="browse">
      ...
      <div class="relatedGrid">
        {% assign items = site.countries | sort: "title" %}
        {% for it in items %}
