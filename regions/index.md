...
layout: default
title: Regions
description: Regions include states, provinces, and planning regions.
permalink: /regions/
breadcrumbs:
  - label: Regions
---
...
<section class="hero">
  ...
  <div class="wrap heroInner">
    ...
    <p class="dek">Regions include states, provinces, and planning regions.</p>
    <div class="searchPanel">
      <div class="searchBar"><span aria-hidden="true">⌕</span><input data-search-input placeholder="Search Regions…" autocomplete="off"></div>
  ...
  <article class="article">
    <section class="section" id="browse">
      ...
      <div class="relatedGrid">
        {% assign items = site.regions | sort: "title" %}
        {% for it in items %}
