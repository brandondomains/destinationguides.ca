...
title: Rome
slug: rome
description: 'Rome: production-grade planning logic and realistic pacing.'
dek: 'Rome: production-grade planning logic and realistic pacing.'
updated: '2026-02-21'
guide_type: City
tags:
- City
...
country_slug: italy
region_slug: lazio
overview: Rome requires strict anchor sequencing to avoid museum fatigue.
payments: Cards common; small trattorias may vary.
connectivity: Walk-heavy; transit secondary.
arrival_tip: Choose lodging inside Aurelian Walls.
arrival_verify: Colosseum/Vatican timed entry rules.
getting_around: Walking + selective metro; separate Vatican day.
things_intro: 'Win condition: 4 anchor days maximum.'
itineraries:
- title: 4 days
  tag: Core
  steps:
...
checklist:
- Pre-book Vatican
- Avoid stacking Vatican + Colosseum same day
- Plan mid-trip rest
stay_areas:
...
- title: Trastevere
  tag: Evening
  desc: Local dining hub.
arrival:
- option: Fiumicino
  best_for: International arrivals
  notes: Leonardo Express; verify schedule.
---
